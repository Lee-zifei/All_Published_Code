...
L = 40;
%%
% The following colors are typically used for visualizing seismic data:
if (iop == 1);
...
%%
%The following colors are used to represent gravity anomalies, magnetic anomalies, and electrical anomalies:
