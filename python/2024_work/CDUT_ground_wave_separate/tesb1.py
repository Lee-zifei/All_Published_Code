...
if __name__ == '__main__':
    ...
    # add = (res1+res2+res2*window*10)/2
    ...
    ax6.imshow(hyper_in-res2,cmap=mm,vmax = clip,vmin = -clip,aspect=0.1)
    ...
    # io.savemat(filename2, {'wudt_STA_res2_p2': res2})
