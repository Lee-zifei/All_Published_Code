...
_C.DATA.FINE_TUNE = False
_C.GPU = [1,2,3,4,5,6,7]
...
# Deblending Transformer parameters
_C.MODEL.DT = CN()
...
_C.TRAIN.WARMUP_EPOCHS = 10 ## need change to 10
_C.TRAIN.WEIGHT_DECAY = 0.01 ## need change to 0.01
_C.TRAIN.BASE_LR = 1e-3
_C.TRAIN.WARMUP_LR = 5e-4
_C.TRAIN.MIN_LR = 5e-9
# Clip gradient norm
_C.TRAIN.CLIP_GRAD = 50
...
_C.TRAIN.LOSS.WEIGHTH = 0.5
_C.TRAIN.LOSS.WEIGHTV = 0.5
# -----------------------------------------------------------------------------
# Testing settings
# -----------------------------------------------------------------------------
_C.TEST = CN()
...
_C.PRINT_FREQ = 1
# Fixed random seed
_C.SEED = 20191110   ### or the university answer 42
